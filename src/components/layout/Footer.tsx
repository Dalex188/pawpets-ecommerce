      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contacto" className="text-sm text-white/70 transition-colors hover:text-white">
                  Contacto
                </Link>
              </li>
              <li>
                <Link href="/envios" className="text-sm text-white/70 transition-colors hover:text-white">
                  Envíos y devoluciones
                </Link>
              </li>
              <li>
                <Link href="/terminos" className="text-sm text-white/70 transition-colors hover:text-white">
          ...
          <div>
            ...
            <p className="mb-4 text-sm leading-relaxed text-white/70">
              Tu tienda de confianza para productos de mascotas. Calidad y
              variedad para consentir a tus animales favoritos.
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 border-t border-white/20 pt-6 text-center">
          <p className="text-sm text-white/60">
            &copy; 2026 PawPets. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
